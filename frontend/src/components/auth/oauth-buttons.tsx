...
export function OAuthButtons({ mode, disabled }: OAuthButtonsProps) {
  ...
  const handleGoogleOAuth = () => {
    if (!GOOGLE_CLIENT_ID) {
      console.warn('Google OAuth is not configured. Set NEXT_PUBLIC_GOOGLE_CLIENT_ID.');
      return;
    }
  ...
  const handleGithubOAuth = () => {
    if (!GITHUB_CLIENT_ID) {
      console.warn('GitHub OAuth is not configured. Set NEXT_PUBLIC_GITHUB_CLIENT_ID.');
      return;
    }
